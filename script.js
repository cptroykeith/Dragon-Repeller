...
const locations = [
    ...
    {
        name: "cave",
        "button text": ["Fight slime", "Fightt fanged beast", "Go to town square"],
    ...
    },
    {
        ...
        text: "You find a secret game. Pick a number above. Ten nummbers will be randomly chosen between 0 and 10. If the number you choose matches one of the random numbers, you win!"
    }
...
function goFight() {
    ...
    monsterHealthText.innerText = monsterHealth;s
}
